...
def consulta(request):
    ...
    if campo == 'nome':
        ...
        if consulta.find(',') > 0 or consulta.filter('.') > 0:
...
def graficos(request):
    ...
    return render(request, 'graficos.html', {'titulo': titulo, 'salarioM': salarioM, 'salarioF': salarioF, 'idadeM': idadeM, 'idadeF': idadeF})
